@section('site_title')
    <title>درمانگاه شبانه روزی امام حسین (ع) | تخصص ({{$expertise->name}})</title>
@endsection
                    ...
                    <div class="row search-row">
                        <div class="col-md-9">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <h3 class="weight-h3 spurple">
                                        دکتر&nbsp;{{$value->doctor->f_name}} {{$value->doctor->l_name}}</h3>
                                    <p class="small-s2-font margin-bottom-0 margin-right-05 attribute"><i
                                            ...
                                            class="small-n-font">متخصص:</span><span
                                            class="highlight">&nbsp;{{$value->expertise->name}}</span>
                                    </p>

                                    <p class="small-s2-font margin-bottom-0 margin-right-05 attribute"><i
                                            class="fa  fa-check-square-o spurple padding-left-05 small-s2-font"></i><span
                                            class="small-n-font">حوزه تخصصی:</span>
                                        <span>&nbsp{{$value->specialized_fields}}</span>
                                    </p>
                                        ...
                                        <div id="info_div-{{$value['id']}}" class="more-search-content"
                                            ...
                                            <ul>
                                                ...
                                                <li class="small-s2-font margin-bottom-0 margin-right-05 attribute"><i
                                                    ...
                                                    <span class="small-s-font">{{$value['phone']}}</span></li>
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="hospital-intro-pic center-block" id="sina-hospital-pic"
                                 style="background-image: url({{$value->doctor->profile}})">
                            </div>
