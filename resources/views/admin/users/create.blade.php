                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input onkeyup="this.value=removeSpaces(this.value)" type="text"
                                           ...
                                           value="{{ old('national_code') }}" id="national_code" name="national_code"
                                ...
                                <div class="form-group">
                                    <label for="birthday">تاریخ تولد کاربر</label>
                                    <input readonly type="text"
                                           class="form-control @error('birthday') is-invalid @enderror"
                                           value="{{ old('birthday') }}"
                                           id="birthday" name="birthday"
                                           placeholder="تاریخ تولد کاربر را انتخاب کنید"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control  @error('sex') is-invalid @enderror"
                                        ...
                                        <option @if (old('sex')==\App\Models\User::MALE)
                                                selected="selected"
                                                @endif value="{{\App\Models\User::MALE}}">@lang(\App\Models\User::MALE)</option>

                                        <option @if (old('sex')==\App\Models\User::FEMALE)
                                                selected="selected"
